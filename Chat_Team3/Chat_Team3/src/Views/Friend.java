 ...
 * @author ACER
 */
public class Friend extends javax.swing.JPanel {
    ...
    public Friend(String avatar, String name, String nick_name, javax.swing.JFrame parent) {
        initComponents();
        this.user_name = name;
        this.email = email;
        this.avatar = avatar;
